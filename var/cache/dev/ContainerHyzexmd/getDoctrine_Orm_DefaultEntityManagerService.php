...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\AppBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\GestionFaenaBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\GestionSigcerBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\GestionVentasBundle\\Entity')]);

$b->addDriver($c, 'AppBundle\\Entity');
$b->addDriver($c, 'GestionFaenaBundle\\Entity');
$b->addDriver($c, 'GestionSigcerBundle\\Entity');
$b->addDriver($c, 'GestionVentasBundle\\Entity');
...
$a->setEntityNamespaces(['AppBundle' => 'AppBundle\\Entity', 'GestionFaenaBundle' => 'GestionFaenaBundle\\Entity', 'GestionSigcerBundle' => 'GestionSigcerBundle\\Entity', 'GestionVentasBundle' => 'GestionVentasBundle\\Entity']);
...
$a->addCustomStringFunction('IF', 'GestionFaenaBundle\\Extensions\\DoctrineExtensions\\Query\\Mysql\\IfElse');
