...
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/informes/gerencia/'), [0 => 'ROLE_SUPER_ADMIN'], NULL);
$instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/config/'), [0 => 'ROLE_ADMIN'], NULL);
