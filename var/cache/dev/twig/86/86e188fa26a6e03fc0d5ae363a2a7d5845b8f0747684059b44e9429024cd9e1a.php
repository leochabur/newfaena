...
class __TwigTemplate_8304c1ee7376b7a4389991d422396190f6b904272cdc05fe40fa7b1be75f66c8 extends \Twig\Template
{
...
";
    ...
    {
        return array (  145 => 37,  136 => 36,  115 => 22,  111 => 21,  107 => 20,  103 => 19,  98 => 17,  94 => 16,  91 => 15,  85 => 12,  82 => 11,  80 => 10,  71 => 9,  53 => 6,  31 => 1,);
    }
...
{% endif %}
    ...
    <form action=\"{{ path(\"fos_user_security_check\") }}\" method=\"post\" class=\"form-signin\" novalidate=\"novalidate\">
        <input type=\"hidden\" name=\"_csrf_token\" value=\"{{ csrf_token }}\" />

        <img src=\"{{ asset('resources/img/logo.jpg') }}\" alt=\"Lights\" style=\"width:70%\">
        <label for=\"username\" class=\"sr-only\">{{ 'security.login.username'|trans }}</label>
        <input type=\"text\" id=\"username\" name=\"_username\" value=\"{{ last_username }}\" placeholder=\"Usuario\" class=\"form-control\" required autofocus />
...
{% endblock %}", "FOSUserBundle:Security:login.html.twig", "E:\\proyectos\\sapucai\\gestionFaena\\app/Resources/FOSUserBundle/views/Security/login.html.twig");
    }
}
