 ...
 */
class DestinatarioExportacion extends \GestionSigcerBundle\Entity\opciones\DestinatarioExportacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionSigcerBundle\\Entity\\opciones\\DestinatarioExportacion' . "\0" . 'id', '' . "\0" . 'GestionSigcerBundle\\Entity\\opciones\\DestinatarioExportacion' . "\0" . 'razonSocial', '' . "\0" . 'GestionSigcerBundle\\Entity\\opciones\\DestinatarioExportacion' . "\0" . 'direccion', '' . "\0" . 'GestionSigcerBundle\\Entity\\opciones\\DestinatarioExportacion' . "\0" . 'telefono', '' . "\0" . 'GestionSigcerBundle\\Entity\\opciones\\DestinatarioExportacion' . "\0" . 'codigoPostal'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DestinatarioExportacion $proxy) {
