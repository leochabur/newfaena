 ...
 */
class ValorTexto extends \GestionFaenaBundle\Entity\faena\ValorTexto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ValorTexto' . "\0" . 'valor'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ValorTexto $proxy) {
