 ...
 */
class CategoriaArticulo extends \GestionFaenaBundle\Entity\gestionBD\CategoriaArticulo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\CategoriaArticulo' . "\0" . 'id', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\CategoriaArticulo' . "\0" . 'categoria', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\CategoriaArticulo' . "\0" . 'orden', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\CategoriaArticulo' . "\0" . 'grupo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoriaArticulo $proxy) {
