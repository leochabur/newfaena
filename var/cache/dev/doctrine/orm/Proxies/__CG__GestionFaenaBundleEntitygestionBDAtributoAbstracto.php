 ...
 */
class AtributoAbstracto extends \GestionFaenaBundle\Entity\gestionBD\AtributoAbstracto implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\AtributoAbstracto' . "\0" . 'id', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\AtributoAbstracto' . "\0" . 'atributo', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\AtributoAbstracto' . "\0" . 'atributos'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AtributoAbstracto $proxy) {
