 ...
 */
class ValorNumerico extends \GestionFaenaBundle\Entity\faena\ValorNumerico implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ValorNumerico' . "\0" . 'valor', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ValorNumerico' . "\0" . 'unidadMedida', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ValorNumerico' . "\0" . 'decimales', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ValorNumerico' . "\0" . 'acumula', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ValorNumerico' . "\0" . 'promedia'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ValorNumerico $proxy) {
    ...
    public function getData($redonedo = true)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getData', [$redonedo]);

        return parent::getData($redonedo);
    }
    ...
    public function setPrePersist()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPrePersist', []);

        return parent::setPrePersist();
    }
