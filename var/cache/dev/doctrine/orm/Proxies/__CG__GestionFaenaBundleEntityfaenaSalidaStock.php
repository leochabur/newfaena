 ...
 */
class SalidaStock extends \GestionFaenaBundle\Entity\faena\SalidaStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SalidaStock $proxy) {
