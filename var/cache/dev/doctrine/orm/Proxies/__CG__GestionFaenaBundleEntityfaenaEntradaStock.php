 ...
 */
class EntradaStock extends \GestionFaenaBundle\Entity\faena\EntradaStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EntradaStock $proxy) {
