 ...
 */
class TransformarTransferirStock extends \GestionFaenaBundle\Entity\faena\TransformarTransferirStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransformarTransferirStock $proxy) {
