...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'procesos', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'perfiles', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function isPerfilVenta()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isPerfilVenta', []);

        return parent::isPerfilVenta();
    }
    ...
    public function isPerfilFaena()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isPerfilFaena', []);

        return parent::isPerfilFaena();
    }
    ...
    public function clearProcesos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'clearProcesos', []);

        return parent::clearProcesos();
    }
    ...
    public function addPerfile(\AppBundle\Entity\Perfil $perfile)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addPerfile', [$perfile]);

        return parent::addPerfile($perfile);
    }
    ...
    public function removePerfile(\AppBundle\Entity\Perfil $perfile)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removePerfile', [$perfile]);

        return parent::removePerfile($perfile);
    }
