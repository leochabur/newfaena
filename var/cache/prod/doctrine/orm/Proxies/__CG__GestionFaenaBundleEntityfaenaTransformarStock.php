 ...
 */
class TransformarStock extends \GestionFaenaBundle\Entity\faena\TransformarStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TransformarStock $proxy) {
