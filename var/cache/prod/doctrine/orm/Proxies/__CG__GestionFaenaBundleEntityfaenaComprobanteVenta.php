 ...
 */
class ComprobanteVenta extends \GestionFaenaBundle\Entity\faena\ComprobanteVenta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'fecha', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'numero', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'confirmado', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'finalizado', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'entidad', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'items', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'comentario', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'userConfirm', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'fechaConfirmacion', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'userFinalizacion', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'fechaFinalizacion', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'ordenCarga', '' . "\0" . 'GestionFaenaBundle\\Entity\\faena\\ComprobanteVenta' . "\0" . 'horarioCarga'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ComprobanteVenta $proxy) {
    ...
    public function getItemOficial()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getItemOficial', []);

        return parent::getItemOficial();
    }
    ...
    public function getItemNoOficial()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getItemNoOficial', []);

        return parent::getItemNoOficial();
    }

    /**
     * {@inheritDoc}
     */
    public function getItemConTipoYArticulo(\GestionFaenaBundle\Entity\faena\TipoVenta $tipo, \GestionFaenaBundle\Entity\gestionBD\Articulo $articulo)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getItemConTipoYArticulo', [$tipo, $articulo]);

        return parent::getItemConTipoYArticulo($tipo, $articulo);
    }
    ...
    public function setFinalizado($finalizado)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFinalizado', [$finalizado]);

        return parent::setFinalizado($finalizado);
    }
    ...
    public function getFinalizado()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getFinalizado', []);
    ...
    public function setUserConfirm(\AppBundle\Entity\User $userConfirm = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserConfirm', [$userConfirm]);

        return parent::setUserConfirm($userConfirm);
    }
    ...
    public function getUserConfirm()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserConfirm', []);

        return parent::getUserConfirm();
    }
    ...
    public function setOrdenCarga(\GestionFaenaBundle\Entity\faena\OrdenCarga $ordenCarga = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setOrdenCarga', [$ordenCarga]);

        return parent::setOrdenCarga($ordenCarga);
    }
    ...
    public function getOrdenCarga()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getOrdenCarga', []);

        return parent::getOrdenCarga();
    }
    ...
    public function setUserFinalizacion(\AppBundle\Entity\User $userFinalizacion = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUserFinalizacion', [$userFinalizacion]);

        return parent::setUserFinalizacion($userFinalizacion);
    }
    ...
    public function getUserFinalizacion()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUserFinalizacion', []);

        return parent::getUserFinalizacion();
    }
    ...
    public function setHorarioCarga(\GestionFaenaBundle\Entity\faena\HorarioCarga $horarioCarga = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHorarioCarga', [$horarioCarga]);

        return parent::setHorarioCarga($horarioCarga);
    }
    ...
    public function getHorarioCarga()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHorarioCarga', []);

        return parent::getHorarioCarga();
    }
