 ...
 */
class ArticuloProcesoFaena extends \GestionFaenaBundle\Entity\gestionBD\ArticuloProcesoFaena implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\ArticuloProcesoFaena' . "\0" . 'id', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\ArticuloProcesoFaena' . "\0" . 'articulo', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\ArticuloProcesoFaena' . "\0" . 'proceso', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\ArticuloProcesoFaena' . "\0" . 'atributos', '' . "\0" . 'GestionFaenaBundle\\Entity\\gestionBD\\ArticuloProcesoFaena' . "\0" . 'activo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ArticuloProcesoFaena $proxy) {
