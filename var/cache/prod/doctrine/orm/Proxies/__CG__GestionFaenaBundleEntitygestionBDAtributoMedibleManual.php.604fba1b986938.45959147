 ...
 */
class AtributoMedibleManual extends \GestionFaenaBundle\Entity\gestionBD\AtributoMedibleManual implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (AtributoMedibleManual $proxy) {
